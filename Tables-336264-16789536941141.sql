...
DROP TABLE prespreslibrary;
DROP TABLE vicepresident;
DROP TABLE firstlady;
DROP TABLE prespets;
...
prespres_libID varchar(3)); 

CREATE TABLE firstlady
(firstlady_num varchar(2) PRIMARY KEY, 
...
(vicepresi_num varchar(3) PRIMARY KEY,  
...
INSERT INTO president
VALUES
('09', 'February 9, 1773','VA','William','H. Harrison','1841','1841','HampdenSydney College','Whig','1841','63','109','1009','309');
INSERT INTO president
VALUES
